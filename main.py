...
def train_nn(sess, model_dir, epochs, batch_size, get_batches_fn, train_op, cross_entropy_loss, input_image,
...
def run():
    ...
    with tf.Session() as sess:
        ...
        train_nn(sess, model_dir, epochs, batch_size, get_batches_fn, train_op,
